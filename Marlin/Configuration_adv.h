...
// @section bltouch
  ...
  #define BLTOUCH_FORCE_SW_MODE // GE
   ...
   */
  //#define BLTOUCH_HS_MODE true // REMOVED FOR UBL
 ...
 */
#define ASSISTED_TRAMMING  // GE
#if ENABLED(ASSISTED_TRAMMING)

  // Define from 3 to 9 points to probe.
  #define TRAMMING_POINT_XY { {  20, 20 }, { 180,  20 }, { 180, 180 }, { 20, 180 } } // GE CHANGED TO BE CLOSER IN 
  ...
  #define ASSISTED_TRAMMING_WIZARD    // GE // Add a Tramming Wizard to the LCD menu
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD // GE ENABLED WIZARD
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -2.0 // GE SET INITIAL POINT TO -2

    // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER } // GE
  #endif
#endif
...
#define BABYSTEPPING  // GE 
  ...
  #define BABYSTEP_ZPROBE_OFFSET  // GE        // Combine M851 Z and Babystepping
...
// The number of linear moves that can be in the planner at once.
  ...
  #define BLOCK_BUFFER_SIZE  16 // GE orginal: 8
#elif HAS_MEDIA
  #define BLOCK_BUFFER_SIZE 32 // GE original: 16 
#else
  #define BLOCK_BUFFER_SIZE 32 // GE original: 16 
#endif
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       800 // GE        // (mA) RMS current. Multiply by 1.414 for peak current.
 ...
 * @section calibrate
 */
#define MECHANICAL_GANTRY_CALIBRATION // GE
#if ENABLED(MECHANICAL_GANTRY_CALIBRATION)
  #define GANTRY_CALIBRATION_CURRENT          600     // Default calibration current in ma
  #define GANTRY_CALIBRATION_EXTRA_HEIGHT      20 // GE     // Extra distance in mm past Z_###_POS to move
