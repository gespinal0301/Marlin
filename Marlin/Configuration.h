...
#define CUSTOM_MACHINE_NAME "GE_DD_803_1125-3" // GE
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -41, -2.65 } // GE // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // GE // (mm) Z Clearance between probe points
...
#define Y_BED_SIZE 199 // GE

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS -31 // GE
#define Z_MIN_POS 0
