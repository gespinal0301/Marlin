...
#define STRING_CONFIG_H_AUTHOR "(BigTreeTech, GE_DD_E3)" // GE // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "GE_DD_805_2143-3" // GE
...
#define HEATER_0_MAXTEMP 310 // GE
#define HEATER_1_MAXTEMP 310 // GE
 ...
 */
#define HOTEND_OVERSHOOT 5   // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT // GE
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 428.3 } // GE
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 50, 25 } // GE increased z axis from 20
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 10000 } // GE
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // GE

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING // GE
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -41, -2.96 } // GE // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define XY_PROBE_FEEDRATE    (150*150) // (mm/min) // GE

// Feedrate for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST  (20*60) // (mm/min) // GE
...
#define Z_CLEARANCE_BETWEEN_PROBES  5 // GE // (mm) Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     10 // GE  // (mm) Z Clearance between multiple probes
...
#define PROBE_OFFSET_ZMIN -20   // GE // (mm)
#define PROBE_OFFSET_ZMAX  20   // GE // (mm)
...
#define AUTO_BED_LEVELING_UBL // GE
...
#define ENABLE_LEVELING_AFTER_G28 // GE

/**
 * Auto-leveling needs preheating
 */
#define PREHEAT_BEFORE_LEVELING // GE
#if ENABLED(PREHEAT_BEFORE_LEVELING)
  #define LEVELING_NOZZLE_TEMP 150   // GE CHANGED TO 150 // (°C) Only applies to E0 at this time
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION // GE
  #if ENABLED(G26_MESH_VALIDATION)
    #define MESH_TEST_NOZZLE_SIZE    0.4  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.2  // (mm) Default layer height for G26.
    #define MESH_TEST_HOTEND_TEMP  240 // GE FOR PETG / (°C) Default nozzle temperature for G26.
    #define MESH_TEST_BED_TEMP      80  // GE FOR PETG  // (°C) Default bed temperature for G26.
  ...
  #define MESH_INSET 20 // GE              // Set Mesh bounds as an inset region of the bed
...
#define HOMING_FEEDRATE_MM_M { (75*60), (75*60), (10*60) } // GE
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_INIT_NOW   // GE // Init EEPROM on first boot after a new build.
#endif
...
#define PREHEAT_2_LABEL       "PETG" // GE
#define PREHEAT_2_TEMP_HOTEND 240 // GE
#define PREHEAT_2_TEMP_BED    80 // GE
